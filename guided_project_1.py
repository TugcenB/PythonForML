...
Original file is located at
    https://colab.research.google.com/drive/1ZCih2iZK_yAIad2TJaLli5NLM62n-s1B
...
def create_invoice():
  ...
  print("After the taxes applied to the total amount :",total_amount_inc_tax)
...
def checkout():
  ...
  if limit == 0:
    print("You don't have any budgets")
  elif total_amount > limit:
    print("The amount you have to pay is above the spending limit. You have to drop")
  else:
    limit -=total_amount
