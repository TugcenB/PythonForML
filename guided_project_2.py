...
Original file is located at
    https://colab.research.google.com/drive/1CZq8nX_ICrytM4_NneLCOJLLJQVTtS3d
...
class HealthInsure:
    ...
    def sup_health_insurance(self,age,chronic_disease,income):
      ...
      elif age<60 and chronic_disease ==False :
...
HI_company1 = HealthInsure('Healthy',2012,'Bob Mayer',"We are care for you",3500,13230)
...
Inventory space of the company: {self.inventory_space} """)
    ...
    def update_inventory_space(self,new_storage_space):
      ...
      print(f"New storage space is {self.new_storage_space}")
...
logistic_company1 = Logistics('LogCom',1990,'Laura','There is no place we cannot reach',5000)
...
class Trading:
    ...
    def print_report(self):
      print(f"""
      The company name, was founded in {self.foundation_year}. The founder of the company is {self.founder_name}.
...
Total revenue: {self.revenue}
    ...
    def update_sales_and_expenses(self,sales,expenses):
      self.sales +=sales
      self.expenses+=expenses
      print("Updated")
...
trading_company1= Trading('TraCom',2005,'Chong','“We revolutionize trading.',3850,1720,1838)
